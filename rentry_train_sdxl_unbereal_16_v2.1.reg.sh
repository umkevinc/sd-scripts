...
function training_Kohya_lora {
    ...
    local training_set="unbereal_16_sdxl_v2.1_reg" #Set this to the base folder for a character.
    local ckpt="$MODEL_DIR/bluePencilXL_v200.safetensors" # Base model(checkpoint) to finetune
    local image_dir="/home/gazai/opt/DATA/ft_inputs/unbereal_16_sdxl_v2.1/"
    local reg_dir="/home/gazai/opt/DATA/ft_inputs/reg_gen_unbereal_1344x768/" #Regulation image folder. Optional, you can point it to an empty folder if you don't want them.
    ...
    local train_batch_size="1" #Amount of images to process at once. I have 8GB of VRAM so I left it at 1, it just worked. Raise if you got more VRAM.
