...
function training_Kohya_lora {
    ...
    local training_set="unbereal_16_sdxl_v2_reg" #Set this to the base folder for a character.
    local ckpt="$MODEL_DIR/bluePencilXL_v200.safetensors" # Base model(checkpoint) to finetune
    local image_dir="/home/gazai/opt/DATA/ft_inputs/unbereal_16_sdxl_v2/"
