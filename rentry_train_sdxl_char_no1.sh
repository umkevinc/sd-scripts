...
function training_Kohya_lora {
    ...
    local training_set="char_no1" #Set this to the base folder for a character.
    local ckpt="$MODEL_DIR/bluePencilXL_v200.safetensors" # Base model(checkpoint) to finetune
    local image_dir="/home/gazai/opt/DATA/ft_inputs/char_no1/"
    local reg_dir="/home/gazai/opt/DATA/ft_inputs/reg_guy" #Regulation image folder. Optional, you can point it to an empty folder if you don't want them.
