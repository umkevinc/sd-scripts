...
MODEL_DIR="${WEBUI_DIR}/models/Stable-diffusion/" # Model folder
...
function training_Kohya_lora {
    ...
    local training_set="char_no3_v3" #Set this to the base folder for a character.
    local ckpt="$MODEL_DIR/animaPencilXL_v150.safetensors" # Base model(checkpoint) to finetune
    local image_dir="/home/gazai/opt/DATA/ft_inputs/char_no3_v3/"
    ...
    accelerate launch --num_cpu_threads_per_process 8 \
		      ...
		      --sample_prompts /home/gazai/workspace/sd-scripts/char_no3_v2_sample_prompt.txt \
