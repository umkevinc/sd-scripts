...
function training_Kohya_lora {
    ...
    local training_set="char_no1_v2" #Set this to the base folder for a character.
    ...
    accelerate launch --num_cpu_threads_per_process 8 \
		      ...
		      --sample_prompts /home/gazai/workspace/sd-scripts/char_no1_v2_sample_prompt.txt \
